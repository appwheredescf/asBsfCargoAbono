...
public class ResponseUltimaTransaccion extends ResponseService {	
	private ArrayList<AF_APNTE_AUDIT_V> apuntes;
	private AF_APNTE_AUDIT_V ultimoApunte;
	
	public ResponseUltimaTransaccion(){
		this.ultimoApunte = new AF_APNTE_AUDIT_V();
		this.apuntes = new ArrayList<ResponseUltimaTransaccion.AF_APNTE_AUDIT_V>();
	}
	
	public ArrayList<AF_APNTE_AUDIT_V> getApuntes() {
		return apuntes;
	}

	public void setApuntes(ArrayList<AF_APNTE_AUDIT_V> apuntes) {
		this.apuntes = apuntes;
	}

	public AF_APNTE_AUDIT_V getUltimoApunte() {
		return ultimoApunte;
	}

	public void setUltimoApunte(AF_APNTE_AUDIT_V ultimoApunte) {
		this.ultimoApunte = ultimoApunte;
	}

	public class AF_APNTE_AUDIT_V {
		private AF_APNTE_E afApnteE;
		private AF_AUDIT_AUX afAuditAux;
		
		public AF_APNTE_AUDIT_V(){
			this.afApnteE = new AF_APNTE_E();
			this.afAuditAux = new AF_AUDIT_AUX();
		}
		
		public AF_APNTE_E getAfApnteE() {
			return afApnteE;
		}
		public void setAfApnteE(AF_APNTE_E afApnteE) {
			this.afApnteE = afApnteE;
		}
	...
	public class AF_APNTE_E{
		...
		public String getCOD_CENT_UO() {
			return COD_CENT_UO;
		}
		public void setCOD_CENT_UO(String cOD_CENT_UO) {
		...
		public String getNUM_SUBAC() {
			return NUM_SUBAC;
		}
		public void setNUM_SUBAC(String nUM_SUBAC) {
			NUM_SUBAC = nUM_SUBAC;
		}
