...
public class DiarioElectronicoDS {
    ...
    private ResponseService InsertaDiario(DiarioElectronicoRequest request) {
        ...
        try {
            ...
            ReqInsertDiarioDTO req = new ReqInsertDiarioDTO();
            req.setIdInternoTermTn(request.getIdInternoTermTn());
            req.setNumSec(request.getNumSec());
            req.setCodTx(request.getCodTx());
            req.setCodTxDi(request.getCodTxDi());
            req.setIdInternoEmplEp(request.getIdInternoEmplEp());
            req.setContrida(request.getContrida());
            req.setSgnCtbleDi(request.getSgnCtbleDi());
            req.setMasMenosDi(request.getMasMenosDi());
            req.setNumSecAc(request.getNumSecAc());
            req.setImpNominal(request.getImpNominal());
            req.setCodNumrcoMoneda(request.getCodNumrcoMoneda());
            req.setImpSdo(request.getImpSdo());
            req.setCodNumrcoMoneda1(request.getCodNumrcoMoneda1());
            req.setCodErr1(request.getCodErr1());
            req.setCodErr2(request.getCodErr2());
            req.setCodErr3(request.getCodErr3());
            req.setCodErr4(request.getCodErr4());
            req.setCodErr5(request.getCodErr5());
            req.setModoTx(request.getModoTx());
            req.setSituTx(request.getSituTx());
            req.setValorDtllTx(request.getValorDtllTx());
            req.setIdEmplAut(request.getIdEmplAut());
            req.setFechaAnul(request.getFechaAnul());
            req.setIdTermAnul(request.getIdTermAnul());
            req.setIdEmplAnul(request.getIdEmplAnul());
            req.setNumSecAnul(request.getNumSecAnul());
            req.setCodRespuesta(request.getCodRespuesta());
            req.setCodNrbeEn(request.getCodNrbeEn());
            req.setCodInternoUo(request.getCodInternoUo());
            req.setCodNrbeEnFsc(request.getCodNrbeEnFsc());
            req.setCodInternoUoFsc(request.getCodInternoUoFsc());
            req.setFechaOprcn(StrFecOper);
            req.setHoraOprcn(request.getHoraOprcn());
            req.setFechaCtble(StFecConr);
            req.setFechaValor(StrFecValor);
            req.setCodClopSist(request.getCodClopSist());
            req.setTipoSbclop(request.getTipoSbclop());
            req.setNumPuesto(request.getNumPuesto());
            req.setFechaOff(request.getFechaOff());
            req.setIdTermOff(request.getIdTermOff());
            req.setIdEmplOff(request.getIdEmplOff());
            req.setNumSecOff(request.getNumSecOff());
            req.setImpNominalX(StrImpNOmX);
            req.setClaveAnulDi(request.getClaveAnulDi());
            req.setDiTextArg1(request.getDiTextArg1());
            req.setDiTextArg2(request.getDiTextArg2());
            req.setDiTextArg3(request.getDiTextArg3());
            req.setDiTextArg4(request.getDiTextArg4());
            req.setDiTextArg5(request.getDiTextArg5());
            req.setFechaPc(StPcFec);
            req.setHoraPc(request.getHoraPc());
            req.setHoraPcFinal(request.getHoraPcFinal());
            String resp = util.callRestPost(req, propDs.getURL_INSERTA_DIARIO());
            System.out.println("Respuesta " + resp);
            ResInsertaDiarioDTO respD = new ResInsertaDiarioDTO();
            Gson gson = new Gson();
            respD = gson.fromJson(resp, ResInsertaDiarioDTO.class);
            if (respD.getStatus().equals("1")) {
    ...
    public ResponDiaPend RegistraCargoAbonoPendiente(String entidad, String centro, String terminal, String empleado,
                                                     ...
                                                     String fechaOperacion, String cajaInt, String horaOperacion, String fechaValor) {
    ...
    public ResponDiaPend RegistraCargoAbonoPendienteInter(String entidad, String centro, String terminal,
                                                          ...
                                                          String numSec, String fechaOperacion, String cajaInt, String StrClop, String StrSubClop, String fechaValor) {
        ResponDiaPend response = new ResponDiaPend();
        try {
            try {
                ResponNumSec oNumS = ObtieneNumSec(entidad, centro, terminal);
