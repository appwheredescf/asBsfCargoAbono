...
public class DiarioElectronicoDS {
	...
	private ResponseService InsertaDiario(DiarioElectronicoRequest request) {
		...
		try {
			...
			xml = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:dat=\"http://ws.wso2.org/dataservice\">"
					+ "<soapenv:Header/>" + "<soapenv:Body>" + "<dat:InsertaDiarioElectronico>"
					+ "<dat:idInternoTermTn>" + request.getIdInternoTermTn() + "</dat:idInternoTermTn>" + "<dat:numSec>"
					+ request.getNumSec() + "</dat:numSec>" + "<dat:codTx>" + request.getCodTx() + "</dat:codTx>"
					+ "<dat:codTxDi>" + request.getCodTxDi() + "</dat:codTxDi>" + "<dat:idInternoEmplEp>"
					+ request.getIdInternoEmplEp() + "</dat:idInternoEmplEp>" + "<dat:contrida>" + request.getContrida()
					+ "</dat:contrida>" + "<dat:sgnCtbleDi>" + request.getSgnCtbleDi() + "</dat:sgnCtbleDi>"
					+ "<dat:masMenosDi>" + request.getMasMenosDi() + "</dat:masMenosDi>" + "<dat:numSecAc>"
					+ request.getNumSecAc() + "</dat:numSecAc>" + "<dat:impNominal>" + request.getImpNominal()
					+ "</dat:impNominal>" + "<dat:codNumrcoMoneda>" + request.getCodNumrcoMoneda()
					+ "</dat:codNumrcoMoneda>" + "<dat:impSdo>" + request.getImpSdo() + "</dat:impSdo>"
					+ "<dat:codNumrcoMoneda1>" + request.getCodNumrcoMoneda1() + "</dat:codNumrcoMoneda1>"
					+ "<dat:codErr1>" + request.getCodErr1() + "</dat:codErr1>" + "<dat:codErr2>" + request.getCodErr2()
					+ "</dat:codErr2>" + "<dat:codErr3>" + request.getCodErr3() + "</dat:codErr3>" + "<dat:codErr4>"
					+ request.getCodErr4() + "</dat:codErr4>" + "<dat:codErr5>" + request.getCodErr5()
					+ "</dat:codErr5>" + "<dat:modoTx>" + request.getModoTx() + "</dat:modoTx>" + "<dat:situTx>"
					+ request.getSituTx() + "</dat:situTx>" + "<dat:valorDtllTx>" + request.getValorDtllTx()
					+ "</dat:valorDtllTx>" + "<dat:idEmplAut></dat:idEmplAut>"
					+ "<dat:fechaAnul xsi:nil=\"true\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"http://ws.wso2.org/dataservice\"/>"
					+ "<dat:idTermAnul>" + request.getIdTermAnul() + "</dat:idTermAnul>" + "<dat:idEmplAnul>"
					+ request.getIdEmplAnul() + "</dat:idEmplAnul>" + "<dat:numSecAnul>" + request.getNumSecAnul()
					+ "</dat:numSecAnul>" + "<dat:codRespuesta>" + request.getCodRespuesta() + "</dat:codRespuesta>"
					+ "<dat:codNrbeEn>" + request.getCodNrbeEn() + "</dat:codNrbeEn>" + "<dat:codInternoUo>"
					+ request.getCodInternoUo() + "</dat:codInternoUo>" + "<dat:codNrbeEnFsc>"
					+ request.getCodNrbeEnFsc() + "</dat:codNrbeEnFsc>" + "<dat:codInternoUoFsc>"
					+ request.getCodInternoUoFsc() + "</dat:codInternoUoFsc>" + "<dat:fechaOprcn>" + StrFecOper
					+ "</dat:fechaOprcn>" + "<dat:horaOprcn>" + request.getHoraOprcn() + "</dat:horaOprcn>"
					+ "<dat:fechaCtble>" + StFecConr + "</dat:fechaCtble>" + "<dat:fechaValor>" + StrFecValor
					+ "</dat:fechaValor>" + "<dat:codClopSist>" + request.getCodClopSist() + "</dat:codClopSist>"
					+ "<dat:tipoSbclop>" + request.getTipoSbclop() + "</dat:tipoSbclop>" + "<dat:numPuesto>"
					+ request.getNumPuesto() + "</dat:numPuesto>"
					+ "<dat:fechaOff xsi:nil=\"true\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns=\"http://ws.wso2.org/dataservice\"/>"
					+ "<dat:idTermOff/>" + "<dat:idEmplOff/>" + "<dat:numSecOff>" + request.getNumSecOff()
					+ "</dat:numSecOff>" + "<dat:impNominalX>" + StrImpNOmX + "</dat:impNominalX>" + "<dat:claveAnulDi>"
					+ request.getClaveAnulDi() + "</dat:claveAnulDi>" + "<dat:diTextArg1>" + request.getDiTextArg1()
					+ "</dat:diTextArg1>" + "<dat:diTextArg2>" + request.getDiTextArg2() + "</dat:diTextArg2>"
					+ "<dat:diTextArg3>" + request.getDiTextArg3() + "</dat:diTextArg3>" + "<dat:diTextArg4>"
					+ request.getDiTextArg4() + "</dat:diTextArg4>" + "<dat:diTextArg5>" + request.getDiTextArg5()
					+ "</dat:diTextArg5>" + "<dat:fechaPc>" + StPcFec + "</dat:fechaPc>" + "<dat:horaPc>"
					+ request.getHoraPc() + "</dat:horaPc>" + "</dat:InsertaDiarioElectronico>" + "</soapenv:Body>"
					+ "</soapenv:Envelope>";
	...
	public ResponDiaPend RegistraCargoAbonoPendiente(String entidad, String centro, String terminal, String empleado,
			String tipoOp, String concepto, String importe, String importaSldo, String numSecAc, String numSec,
	...
	public ResponDiaPend RegistraCargoAbonoPendienteInter(String entidad, String centro, String terminal,
			String empleado, String tipoOp, String concepto, String importe, String importaSldo, String numSecAc,
			String numSec, String fechaOperacion, String cajaInt, String StrClop, String StrSubClop) {
		ResponDiaPend response = new ResponDiaPend();
	...
	public ResponseRegistroDiarioElectronico UltimoMovimiento(String terminal, String entidad, String centro) {
		...
		try {
			xml = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:dat=\"http://ws.wso2.org/dataservice\">"
					+ "<soapenv:Header/>" + "<soapenv:Body>" + " <dat:ConsultaUltimoMovimiento>" + "	 <dat:TERMINAL>"
					+ terminal + "</dat:TERMINAL>" + "  <dat:ENTIDAD>" + entidad + "</dat:ENTIDAD>" + "  <dat:CENTRO>"
					+ centro + "</dat:CENTRO>" + " </dat:ConsultaUltimoMovimiento>" + "</soapenv:Body>"
					+ "</soapenv:Envelope>";
			...
			if (outputString.contains("RespuetaDiario")) {
				...
				for (int i = 0; i < RespuetaDiario.getLength(); i++) {
					...
					diario.setCodNumrcoMoneda(
							eElement.getElementsByTagName("COD_NUMRCO_MONEDA").item(0).getTextContent());
					...
					diario.setCodInternoUoFsc(
							eElement.getElementsByTagName("COD_INTERNO_UO_FSC").item(0).getTextContent());
					...
					diario.setIdInternoEmplEp(
							eElement.getElementsByTagName("ID_INTERNO_EMPL_EP").item(0).getTextContent());
					diario.setIdInternoTermTn(
							eElement.getElementsByTagName("ID_INTERNO_TERM_TN").item(0).getTextContent());
					...
					diario.setCodNumrcoMoneda1(
							eElement.getElementsByTagName("COD_NUMRCO_MONEDA1").item(0).getTextContent());
	...
	public ResponseService ObtieneMovimiento(String terminal, String fechaPc, String horaPc, String numSec,
			String horaOprcn, String codRespuesta) {
		ResponseService response = new ResponseService();
		...
		try {
			xml = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:dat=\"http://ws.wso2.org/dataservice\">"
					+ "<soapenv:Header/>" + "<soapenv:Body>" + " <dat:ObtenerMovimiento>" + "	 <dat:TERMINAL>"
					+ terminal + "</dat:TERMINAL>" + "  <dat:FECHA>" + fechaPc + "</dat:FECHA>" + "  <dat:HORA>"
					+ horaPc + "</dat:HORA>" + " </dat:ObtenerMovimiento>" + "</soapenv:Body>" + "</soapenv:Envelope>";
	...
	public ResponseService ActualizaRegistro(ResponDiaPend oResp) {
		...
		try {
			...
			xml = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:dat=\"http://ws.wso2.org/dataservice\">"
					+ "<soapenv:Header/>" + "<soapenv:Body>" + " <dat:ActualizaDiario>" + "	 <dat:NUM_SEC>"
					+ oResp.getNUMSEC() + "</dat:NUM_SEC>" + "	 <dat:HORA_OPRCN>" + oResp.getHORA_OPERACION()
					+ "</dat:HORA_OPRCN>" + "	 <dat:COD_RESPUESTA>" + oResp.getCOD_RESPUESTA()
					+ "</dat:COD_RESPUESTA>" + "	 <dat:IMP_SDO>" + oResp.getIMP_SDO() + "</dat:IMP_SDO>"
					+ "	 <dat:TERMINAL>" + oResp.getTERMINAL() + "</dat:TERMINAL>" + "  <dat:FECHA_PC>"
					+ oResp.getFEC_PC() + "</dat:FECHA_PC>" + "  <dat:HORA_PC>" + oResp.getHORA_PC() + "</dat:HORA_PC>"
					+ " </dat:ActualizaDiario>" + "</soapenv:Body>" + "</soapenv:Envelope>";
	...
	public ResponseService RegistraImprSaldo(String entidad, String centro, String terminal, String empleado,
	...
	public ResponseService ActualizaNumSec(String entidad, String centro, String terminal) {
		...
		try {
			xml = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:dat=\"http://ws.wso2.org/dataservice\">"
					+ " <soapenv:Header/>" + " <soapenv:Body>" + "    <dat:UpdateNumSec>" + "       <dat:ENTIDAD>"
					+ entidad + "</dat:ENTIDAD>" + "       <dat:CENTRO>" + centro + "</dat:CENTRO>"
					+ "       <dat:TERMINAL>" + terminal + "</dat:TERMINAL>" + "    </dat:UpdateNumSec>"
	...
	public ResponNumSec ObtieneNumSec(String entidad, String centro, String terminal) {
		...
		try {
			...
			xml = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:dat=\"http://ws.wso2.org/dataservice\">"
					+ " <soapenv:Header/>" + " <soapenv:Body>" + "    <dat:GetNumSec>" + "       <dat:ENTIDAD>"
					+ entidad + "</dat:ENTIDAD>" + "       <dat:CENTRO>" + centro + "</dat:CENTRO>"
					+ "       <dat:TERMINAL>" + terminal + "</dat:TERMINAL>" + "    </dat:GetNumSec>"
					+ " </soapenv:Body>" + "</soapenv:Envelope>";
		...
		try {
			...
			if (outputString.contains("ConsultaUltimoMovimientoPendienteResp")) {
				...
				for (int i = 0; i < RespuetaDiario.getLength(); i++) {
					...
					String StrCOD_NUMRCO_MONEDA = eElement.getElementsByTagName("COD_NUMRCO_MONEDA").item(0)
							.getTextContent();
					...
					// String StrHORA_PC_FINAL =
					// eElement.getElementsByTagName("HORA_PC_FINAL").item(0).getTextContent();
					String StrCOD_INTERNO_UO = eElement.getElementsByTagName("COD_INTERNO_UO").item(0).getTextContent();
					String StrCOD_INTERNO_UO_FSC = eElement.getElementsByTagName("COD_INTERNO_UO_FSC").item(0)
							.getTextContent();
					String StrCOD_NRBE_EN = eElement.getElementsByTagName("COD_NRBE_EN").item(0).getTextContent();
					String StrCOD_NRBE_EN_FSC = eElement.getElementsByTagName("COD_NRBE_EN_FSC").item(0)
							.getTextContent();
					...
					String StrID_INTERNO_EMPL_EP = eElement.getElementsByTagName("ID_INTERNO_EMPL_EP").item(0)
							.getTextContent();
					String StrID_INTERNO_TERM_TN = eElement.getElementsByTagName("ID_INTERNO_TERM_TN").item(0)
							.getTextContent();
	...
	public String SalidaResponse(String vista, String StrUrl, String action, String StrRep) {
		...
		try {
			...
			outputString = outputString
					.replace("<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\">", "");
